...
<div class="navbar-custom">
    <div class="container-fluid">
        ...
        <li class="d-lg-inline-block">
                <a class="nav-link  arrow-none waves-effect waves-light" 
                   href="{{route('user.carts.index')}}">
                   <i data-feather="shopping-cart"> </i> <span class="badge badge-pill badge-danger">{{!empty($cart_count)?$cart_count:''}}</span>
