...
Route::group(['middleware'=>'locale'],function (){
    ...
    Route::prefix('user')->group(function (){
        ...
        Route::get('/register/{id}','User\Auth\RegisterController@showEditRegisterForm');
        ...
        Route::post('/update/register','User\Auth\RegisterController@update')->name('user.edit_register');
    ...
    Route::group(['middleware'=>'auth:manager','prefix'=>'/manager'],function (){
        ...
        //-------------------------------- user approval --------------------------------//
        Route::get('/user_approval','Manager\UserApprovalController@index')->name('manager.user.index');
        Route::get('/user_approval/{id}/view','Manager\UserApprovalController@view')->name('manager.user.view');
        Route::get('/user_approval/approve/{id}','Manager\UserApprovalController@approve')->name('manager.user.approve');
        Route::get('/user_approval/decline/{id}','Manager\UserApprovalController@decline')->name('manager.user.decline');
    ...
    Route::group(['middleware'=>'auth:user','prefix'=>'/user'],function (){
        ...
        //----------------- Category -------------------------------//
        Route::get('products/categories/{id}', 'User\CategoryController@show')->name('user.categories.show');

        //----------------- Sub Category -------------------------------//
        Route::get('products/categories/sub_categories/{id}', 'User\SubCategoryController@show')->name('user.sub-categories.show');
